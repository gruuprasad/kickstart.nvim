-- Based on kickstart.nvim - a starting point for Neovim configuration
-- See :help lua-guide for Neovim Lua API documentation
...
end, { desc = '[T]oggle [D]iagnostics', silent = true, noremap = true })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch in [C]urrent directory' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Call hierarchy - find callers and callees
          ...
          if client and client_supports_method(client, vim.lsp.protocol.Methods.textDocument_prepareCallHierarchy, event.buf) then
            ...
            end, '[G]oto [C]all hierarchy (incoming)')

            map('grC', function()
              require('telescope.builtin').lsp_outgoing_calls()
            end, '[G]oto [C]all hierarchy (outgoing)')
          end
      ...
      vim.diagnostic.config {
        ...
        -- Disable virtual text to reduce clutter - diagnostics still visible in sign column and on hover
        virtual_text = false,
      }
    ...
    config = function()
      require('aerial').setup {
        ...
        on_attach = function(bufnr)
          ...
          vim.keymap.set('n', '{', '<cmd>AerialPrev<CR>', { buffer = bufnr, desc = 'Previous code symbol' })
